...
def random_phantom(space):
    n = 20

    scale = np.random.randn(n) * 0.2
    axis_0 = np.random.randn(n) * 0.2
    axis_1 = np.random.randn(n) * 0.2
    x_0 = np.random.randn(n) * 0.5
    y_0 = np.random.randn(n) * 0.5
